...
{\bf Machine Learning Toolkits}: scikit-learn, Theano, SVM-Light, CRFsuite\\
{\bf NLP and IR Toolkits}: NLTK, Stanford CoreNLP, Lucene\\
{\bf Databases}: MySQL, SQLite, MongoDB\\
